...
При заходе на сервер testkedo_v1.mosinzhproekt.ru запросы уходят на сервер http://192.168.11.110 и весь контент тянется оттуда. Домен testkedo_v1.mosinzhproekt.ru работает по https, а http://192.168.11.110 по https не может. При этом в браузерной строке отображается домен testkedo_v1.mosinzhproekt.ru. 
